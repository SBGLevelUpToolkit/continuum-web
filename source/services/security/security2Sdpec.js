...
describe('Security Services', function() {
    ...
    //
    //    beforeEach(function() {
    //        module('cn.authInterceptor', function ($httpProvider) {
    //            //save our interceptor
    //            httpProviderIt = $httpProvider;
    //        });
    //
    //        inject(function (_authService_, _authInterceptorService_) {
    ...
    //        });
    //
    //        it('should token in the headers after setting', inject(function($httpBackend) {
    //            setAuthData(authService, localStorageService);
    //            $httpBackend.expect('GET','www.example.com', null, function (headers) {
    //                return !(expect(headers.Authorization).toBe('Bearer 1234'));
    ...
    //    });
    //
    //    fit('should add authenticated header to the request', inject(function(authService, authInterceptorService, dimensionService, localStorageService, $httpBackend) {
    //        setAuthData(authService, localStorageService);
    //
    //        spyOn(authInterceptorService, "request");//.and.callFake(function() {
    //        //    return (passPromise) ? $q.when() : $q.reject();
    //        //});
    //        $httpBackend.expectGET('undefined/api/dimension', undefined, function(headers) {
    //            return headers[ 'Authorization' ] == 'application/x-www-form-urlencoded';
    //        }).respond(201, '');
    //
    //        dimensionService.query();
    //        $httpBackend.flush();
    //        expect(authInterceptorService.request).toHaveBeenCalled();
    //    }));
    //
